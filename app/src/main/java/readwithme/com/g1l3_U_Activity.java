...
public class g1l3_U_Activity extends Activity implements RecognitionListener {
    ...
    private String LOG_TAG = "g1l3_U_Activity";
    int rawIndex = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g1l3_u);
        tools.setFullScreen(this);
        img_g1l3_I1 = (ImageView) findViewById(R.id.img_g1l3_u1);
        img_g1l3_I2 = (ImageView) findViewById(R.id.img_g1l3_u2);
        img_g1l3_I3 = (ImageView) findViewById(R.id.img_g1l3_u3);
        img_g1l3_I4 = (ImageView) findViewById(R.id.img_g1l3_u4);
        img_g1l3_I5 = (ImageView) findViewById(R.id.img_g1l3_u5);
        img_g1l3_I6 = (ImageView) findViewById(R.id.img_g1l3_u6);
        img_g1l3_I7 = (ImageView) findViewById(R.id.img_g1l3_u7);
        img_g1l3_I8 = (ImageView) findViewById(R.id.img_g1l3_u8);
        img_g1l3_I9 = (ImageView) findViewById(R.id.img_g1l3_u9);
        img_g1l3_I10 = (ImageView) findViewById(R.id.img_g1l3_u10);

        progressBar = (ProgressBar) findViewById(R.id.progressBar_g1l3_u);
        toggleButton = (ToggleButton) findViewById(R.id.toggleButton_lesson_g1l3_u);
        ...
        tools.speakNow(getApplicationContext(),t1, "Identify the words that have short and long Sounds");
       ...
       //progressDialog.setTitle("Wait...");
        ...
        drawableWords1 = new String[] {"drum","Trump","tram","dram","Graham"};
        drawableWords2 = new String[] {"June","John","Jewel","Joan","tune"};
        drawableWords3 = new String[] {"Sun","fun","son","song","sum"};
        drawableWords4 = new String[] {"Lowe's","low","no","blue","flow"};
        drawableWords5 = new String[] {"cop","top","pop","cup","kop"};
        drawableWords6 = new String[] {"Kim","Kia","Kiev","Cube","gif"};
        drawableWords7 = new String[] {"not","knot","Nas","naat"};
        drawableWords8 = new String[] {"soap","so","dope","silk"};
        drawableWords9 = new String[] {"Montauk","Hunter","Honda","montage","ontop"};
        drawableWords10 = new String[]{"toilet","tulip","Philip","volley","stolen"};
