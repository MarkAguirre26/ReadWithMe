...
public class g1q3_Activity extends Activity implements RecognitionListener {
    ...
    private String LOG_TAG = "g1q3_Activity";
    int rawIndex = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g1q2);
       ...
       /* img_g1l3_I1 = (ImageView) findViewById(R.id.g1q1_1_h);
        ...
        progressBar = (ProgressBar) findViewById(R.id.progressBar_g1q3);
        toggleButton = (ToggleButton) findViewById(R.id.toggleButton_g1q3);
