...
public class g3A1Activity extends Activity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3a1_);
        ...
        tools.speakNow(getApplicationContext(), t1, "Indentify what computers sign the picture is");

        img_g2a1_h1 = (ImageView) findViewById(R.id.img_g3a1_h1);
        img_g2a1_h2 = (ImageView) findViewById(R.id.img_g3a1_h2);
        img_g2a1_h3 = (ImageView) findViewById(R.id.img_g3a1_h3);
        img_g2a1_h4 = (ImageView) findViewById(R.id.img_g3a1_h4);
        img_g2a1_h5 = (ImageView) findViewById(R.id.img_g3a1_h5);


        progressBar = (ProgressBar) findViewById(R.id.progressBar_g3a1);
        toggleButton = (ToggleButton) findViewById(R.id.toggleButton_g3a1);
    ...
    private void checkAnswer(ArrayList<String> matches) {
        ...
        for (String result : matches) {
            if (result.contains("power") || result.contains("powder")) {
                ...
                variables.playerScore += 1;
                break;
            } else if (result.contains("setting")) {
                tools.showImage(this, R.drawable.check);
                img_g2a1_h3.setVisibility(View.INVISIBLE);
                //imgSetVisible(img_g2a1_h3, true);
                variables.playerScore += 1;
                break;
            } else if (result.contains("cursor")) {
                tools.showImage(this, R.drawable.check);
                img_g2a1_h4.setVisibility(View.INVISIBLE);
                // imgSetVisible(img_g2a1_h4, true);
                variables.playerScore += 1;
                break;
            } else if (result.contains("speacker")) {
                tools.showImage(this, R.drawable.check);
                img_g2a1_h5.setVisibility(View.INVISIBLE);
