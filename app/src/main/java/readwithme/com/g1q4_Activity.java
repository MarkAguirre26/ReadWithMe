...
public class g1q4_Activity extends Activity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g1q4);
        tools.setFullScreen(this);
        img_g1l3_I1 = (ImageView) findViewById(R.id.img_g1q4_h1);
        img_g1l3_I2 = (ImageView) findViewById(R.id.img_g1q4_h2);
        img_g1l3_I3 = (ImageView) findViewById(R.id.img_g1q4_h3);
        img_g1l3_I4 = (ImageView) findViewById(R.id.img_g1q4_h4);
        img_g1l3_I5 = (ImageView) findViewById(R.id.img_g1q4_h5);


        progressBar = (ProgressBar) findViewById(R.id.progressBar_g1q4);
        toggleButton = (ToggleButton) findViewById(R.id.toggleButton_g1q4);
        ...
        tools.speakNow(getApplicationContext(), t1, "Choose the letter that have initial vowel sound on each picture");
        ...
        drawableWords1 = new String[]{"you", "U", "new", "View", "Yu", "app", "up", "op", "top"};  //U
        drawableWords2 = new String[]{"hey", "a", "hay", "gay"};  //A
        drawableWords3 = new String[]{"gay", "d", "G", "ski", "elephant", "elephants", "elefante", "elephante", "NFL"};  //E
        drawableWords4 = new String[]{"hi", "High", "I", "hide", "icecream", "icecream", "Iscream"};  //I
        drawableWords5 = new String[]{"octopus", "octupus"};  //O
