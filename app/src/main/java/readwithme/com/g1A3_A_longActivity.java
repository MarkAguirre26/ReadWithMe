...
public class g1A3_A_longActivity extends Activity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g1a3_a_long);
        ...
        tools.speakNow(getApplicationContext(), t1, "Read the words that have short A sound");
    ...
    private void checkAnswer(ArrayList<String> arrayList) {
        ...
        for (String result : arrayList) {
            if (result.contains("Arrow") || result.contains("c") || result.contains("c")) {
                tools.showImage(this, R.drawable.check);
                variables.playerScore += 1;
                imgSetVisible(img_g2a2_h1, true);
                break;
            } else if (result.contains("l") || result.contains("Ant")) {
                tools.showImage(this, R.drawable.check);
                variables.playerScore += 1;
                imgSetVisible(img_g2a2_h2, true);
                break;
            } else if (result.contains("Applee") || result.contains("Apple")) {
                tools.showImage(this, R.drawable.check);
                variables.playerScore += 1;
                imgSetVisible(img_g2a2_h3, true);
                break;
            } else if (result.contains("B") || result.contains("Apple")) {
                tools.showImage(this, R.drawable.check);
                variables.playerScore += 1;
                imgSetVisible(img_g2a2_h4, true);
                break;
            } else if (result.contains("mud") || result.contains("Mad")) {
                tools.showImage(this, R.drawable.check);
                variables.playerScore += 1;
