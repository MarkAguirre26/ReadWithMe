...
public class g1l5_Activity extends Activity implements RecognitionListener {
    ...
    private String LOG_TAG = "g1l5_Activity";
    int rawIndex = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g1l5);
        tools.setFullScreen(this);

        img_g1l3_I1 = (ImageView) findViewById(R.id.img_g1l5_highligh1);
        img_g1l3_I2 = (ImageView) findViewById(R.id.img_g1l5_highligh2);
        img_g1l3_I3 = (ImageView) findViewById(R.id.img_g1l5_highligh3);
        img_g1l3_I4 = (ImageView) findViewById(R.id.img_g1l5_highligh4);
        img_g1l3_I5 = (ImageView) findViewById(R.id.img_g1l5_highligh5);
        ...
        tools.speakNow(getApplicationContext(),t1, "Read the words that have final vowel sound");

        progressBar = (ProgressBar) findViewById(R.id.progressBar_g1l5);
        toggleButton = (ToggleButton) findViewById(R.id.toggleButton_lesson5);
       ...
       // progressDialog.setTitle("Wait...");
        ...
        drawableWords1 = new String[]{"kangaroo", "CongaRoom", "KangaRoo", "kangaroos"};
        drawableWords2 = new String[]{"banana", "mañana", "Madonna"};
        drawableWords3 = new String[]{"menu", "minus", "Mini", "middle"};
        drawableWords4 = new String[]{"ice", "eyes", "nice", "iced"};
        drawableWords5 = new String[]{"mango", "Mingo", "Mingle", "Tango", "mangle"};
