...
public class g1q5_Activity extends Activity implements RecognitionListener {
    ...
    private String LOG_TAG = "g1q5_Activity";
    int rawIndex = 1;
...
TextToSpeech t1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g1q5);
        tools.setFullScreen(this);
        img_g1l3_I1 = (ImageView) findViewById(R.id.img_g1q5_h1);
        img_g1l3_I2 = (ImageView) findViewById(R.id.img_g1q5_h3);
        img_g1l3_I3 = (ImageView) findViewById(R.id.img_g1q5_h5);
        img_g1l3_I4 = (ImageView) findViewById(R.id.img_g1q5_h2);
        img_g1l3_I5 = (ImageView) findViewById(R.id.img_g1q5_h4);


        progressBar = (ProgressBar) findViewById(R.id.progressBar_g1q5);
        toggleButton = (ToggleButton) findViewById(R.id.toggleButton_g1q5);
        ...
        tools.speakNow(getApplicationContext(), t1, "Choose the letter that have initial vowel sound according to the picture");
       ...
       // progressDialog.setTitle("Wait...");
        ...
        drawableWords1 = new String[]{"a"};
        drawableWords2 = new String[]{"i"};
        drawableWords3 = new String[]{"e"};
        drawableWords4 = new String[]{"o"};
        drawableWords5 = new String[]{"e"};
