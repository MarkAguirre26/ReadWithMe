...
public class g3Q2Activity extends Activity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3q2);
        ...
        img_g2a1_h1 = (ImageView) findViewById(R.id.img_g3q2_h1);
        img_g2a1_h2 = (ImageView) findViewById(R.id.img_g3q2_h2);
        img_g2a1_h3 = (ImageView) findViewById(R.id.img_g3q2_h3);
        img_g2a1_h4 = (ImageView) findViewById(R.id.img_g3q2_h4);
        img_g2a1_h5 = (ImageView) findViewById(R.id.img_g3q2_h5);


        progressBar = (ProgressBar) findViewById(R.id.progressBar_g3q2);
        toggleButton = (ToggleButton) findViewById(R.id.toggleButton_g3q2);
    ...
    private void checkAnswer(ArrayList<String> matches) {
        ...
        for (String result : matches) {
            if (result.contains("exit")) {
                ...
                break;
            } else if (result.contains("first")) {
                tools.showImage(this, R.drawable.check);
                img_g2a1_h2.setVisibility(View.INVISIBLE);
                //  imgSetVisible(img_g2a1_h2, true);
                variables.playerScore += 1;
                break;
            } else if (result.contains("smoking")) {
                tools.showImage(this, R.drawable.check);
                img_g2a1_h3.setVisibility(View.INVISIBLE);
