...
public class g2A1Activity extends Activity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g2a1_);
        tools.setFullScreen(this);

        img_g2a1_h1 = (ImageView) findViewById(R.id.img_g2a1_h1);
        img_g2a1_h2 = (ImageView) findViewById(R.id.img_g2a1_h2);
        img_g2a1_h3 = (ImageView) findViewById(R.id.img_g2a1_h3);
        img_g2a1_h4 = (ImageView) findViewById(R.id.img_g2a1_h4);
        img_g2a1_h5 = (ImageView) findViewById(R.id.img_g2a1_h5);
        ...
        tools.speakNow(getApplicationContext(), t1, "say the correct letter that will complete the word");


        progressBar = (ProgressBar) findViewById(R.id.progressBar_g2a1);
        toggleButton = (ToggleButton) findViewById(R.id.toggleButton_g2a1);

       // progressDialog = new ProgressDialog(this);
       // progressDialog.setTitle("Wait...");
        progressDialog = new ACProgressCustom.Builder(this).useImages(R.drawable.p1, R.drawable.p2, R.drawable.p3).build();
        imgSetVisible(img_g2a1_h1, false);
    ...
    private void checkAnswer(ArrayList<String> matches) {
        ...
        for (String result : matches) {
            if (result.contains("cat") || result.contains("c") || result.contains("ca")) {
                tools.showImage(this, R.drawable.check);
                variables.playerScore += 1;
                imgSetVisible(img_g2a1_h1, true);
                break;
            } else if (result.contains("monkey") || result.contains("money")) {
                tools.showImage(this, R.drawable.check);
                imgSetVisible(img_g2a1_h2, true);
                variables.playerScore += 1;
                break;
            } else if (result.contains("p") || result.contains("pig")) {
                tools.showImage(this, R.drawable.check);
                imgSetVisible(img_g2a1_h3, true);
                variables.playerScore += 1;
                break;
            } else if (result.contains("s") || result.contains("shark")) {
                tools.showImage(this, R.drawable.check);
                imgSetVisible(img_g2a1_h4, true);
                variables.playerScore += 1;
                break;
            } else if (result.contains("r") || result.contains("rabbit")) {
                tools.showImage(this, R.drawable.check);
