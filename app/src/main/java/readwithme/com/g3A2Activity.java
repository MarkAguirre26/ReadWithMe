...
public class g3A2Activity extends Activity implements RecognitionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g3a2);
        tools.setFullScreen(this);

        img_g2a1_h1 = (ImageView) findViewById(R.id.img_g3a2_h1);
        img_g2a1_h2 = (ImageView) findViewById(R.id.img_g3a2_h2);
        img_g2a1_h3 = (ImageView) findViewById(R.id.img_g3a2_h3);
        img_g2a1_h4 = (ImageView) findViewById(R.id.img_g3a2_h4);
        img_g2a1_h5 = (ImageView) findViewById(R.id.img_g3a2_h5);
        ...
        tools.speakNow(getApplicationContext(),t1, "Identify whta safety sign the picture is");

        progressBar = (ProgressBar) findViewById(R.id.progressBar_g3a2);
        toggleButton = (ToggleButton) findViewById(R.id.toggleButton_g3a2);
    ...
    private void checkAnswer(ArrayList<String> matches) {
        ...
        for (String result : matches) {
            if (result.contains("poison")) {
                ...
                variables.playerScore += 1;
                break;
            } else if (result.contains("stairs")) {
                tools.showImage(this, R.drawable.check);
                img_g2a1_h3.setVisibility(View.INVISIBLE);
                //imgSetVisible(img_g2a1_h3, true);
                variables.playerScore += 1;
                break;
            } else if (result.contains("caution")) {
                tools.showImage(this, R.drawable.check);
                img_g2a1_h4.setVisibility(View.INVISIBLE);
